...
(def text
  "<body><p>This is a text that was written to test something about texts staying put within the given boundaries.</p><p>It was definitely not written to be read out load as it is missing all kinds of stops and pauses but it should look nice and a lot better than a random lorem ipsum. Foobar is the most bar of all foos. Yes indeed it is! No doubt about it. None at all. NONE.</p></body>")
