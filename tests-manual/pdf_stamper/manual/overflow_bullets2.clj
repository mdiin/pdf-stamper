...
(def text
  "<p><p>Introductory paragraph of text spanning multiple lines.</p><ul><li>This is a bullet that is much longer than any bullets you </li><li>would normally see and </li><li>addtionally it is without </li><li>stops or breaks making it even harder to read than it should be </li><li>although bullets should never be very long in any case. </li><li>It is even longer than you had imagined, and now it suddenly contains a comma!</li></ul><p>This is just to test that paragraph afterwards look correct.</p></p>")
